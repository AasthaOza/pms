...
<ul>
   ...
   <li class="active"><a href="view.php"><span>View</span></a></li>
...
?>
    ...
    <form method="post" action="view.php">
        <div style="background-color:rgb(149, 186, 255);  border-radius: 10px; alignment-adjust: central; width:90%; margin-left:5%; margin-top:75px;">
