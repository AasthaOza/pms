...
<table width="100%"  border="0"cellspacing="00" cellpadding="00">
  <tr bgcolor="purple">
    ...
    <th width="140" scope="col"><font color="white" size="5"> Student Sign Up</font></th>
...
<tr>
      <div id='cssmenu' align="center"> 
              <ul>
                 ...
                 <li class="active" ><a href="student.php"><span>Registration Student</span></a></li>
    ...
    <div style="background-color:rgb(149, 186, 255); margin-left: 35%; border-radius: 10px; alignment-adjust: central; width: 35%">
  ...
  <tr>
    ...
    <td><select name="stream" style="width: 193px; height: 2em; font-size: 15px;">
        ...
        <option value="MCS">M.sc(Computers Science)</option>
        <option value="BIT">B.sc(IT)</option>
        <option value="MIT">M.sc(IT)</option>          
